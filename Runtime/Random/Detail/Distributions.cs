...
namespace MakeIt.Random.Detail
{
	...
	public static class Distributions
	{
		...
		{
			using (var file = System.IO.File.Open(string.Format("MakeIt/Random/Generated/{0}{1}.txt", distributionName, tableTypeName), System.IO.FileMode.Create, System.IO.FileAccess.Write))
			{
